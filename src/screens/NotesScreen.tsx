...
const NotesScreen = ({ navigation, route }: NotesScreenProps) => {
  ...
  useEffect(() => {
    navigation.setOptions({ title: IS_ROOT_FOLDER ? "Your notes" : route.params.folderName });
  ...
  return (
    <View style={{ ...styles.container, width: width }}>
      ...
      {loading && <ActivityIndicator style={{ flex: 1, justifyContent: 'center' }} size="large" color="#979797" />}
      {folders &&
